...
class MCAN(nn.Module):
    def __init__(self, answer_size):
        ...
        self.backbone1 = MCA_ED()

        self.attflat_img = AttFlat()
        self.attflat_lang = AttFlat()
        self.attflat_lang1 = AttFlat()
        self.attflat_text = AttFlat()

        self.proj_norm = LayerNorm(flat_out_size)
        self.proj = nn.Linear(flat_out_size, answer_size + 14)


    def forward(self, img_feat, ques_ix, texts):
        # Make mask
