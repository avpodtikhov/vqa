...
TRAIN = {'Images' : VQA_FOLDER + 'boxes/train2014/',
         'Questions_feat' : VQA_FOLDER + 'bert/train2014_qns/',
         'Questions' : VQA_FOLDER + 'albert_base/v2_OpenEnded_mscoco_train2014_questions.json',
...
model_log = VQA_FOLDER + 'models/mcan+albert/log.json'
model_pth = VQA_FOLDER + 'models//mcan+albert/model.pth'
