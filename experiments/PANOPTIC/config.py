...
TRAIN = {'Feats' : VQA_FOLDER + 'panoptic/train2014_feat/',
...
VAL = {'Feats' : VQA_FOLDER + 'panoptic/val2014_feat/',
...
# Раньше было log.json, model.pth
model_log = VQA_FOLDER + 'models/panoptic/log1.json'
model_pth = VQA_FOLDER + 'models/panoptic/model1.pth'
