...
TRAIN = {'Images' : VQA_FOLDER + 'boxes/train2014_boxes/',
...
VAL = {'Images' : VQA_FOLDER + 'boxes/val2014_boxes/',
...
model_log = VQA_FOLDER + 'models/counter_new/log.json'
model_pth = VQA_FOLDER + 'models/counter_new/model.pth'
